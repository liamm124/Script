...
public abstract class WalkToAltar3 extends Task {


    public WalkToAltar3(ClientContext ctx) {
        super(ctx);
    }
    ...
    private Tile PreviousStep = new Tile(3017,5592,0);
    private Tile NextStep = new Tile(3027+Random.nextInt(-1,1),5577+Random.nextInt(-2,2),0);
