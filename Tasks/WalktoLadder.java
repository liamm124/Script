...
public abstract class WalktoLadder extends Task {
    ...
    private static final Tile[] path1 = {new Tile (2454,3240+Random.nextInt(0,5),0),new Tile(2453,3231,0)};
    private static final Tile[] path2 = {new Tile (2454,3244+Random.nextInt(-2,4),0), new Tile(2452,3232,0)};
