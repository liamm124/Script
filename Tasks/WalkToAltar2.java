...
public abstract class WalkToAltar2 extends Task {


    public WalkToAltar2(ClientContext ctx) {
        super(ctx);
    }
    ...
    private Tile PreviousStep = new Tile(3016,5614,0);
     Tile Previous1Step = ctx.movement.destination().tile();
    private Tile NextStep = new Tile(3016+Random.nextInt(-1,1),5592+Random.nextInt(-1,1),0);
